...
namespace CalamityOverhaulLegacy.Content.Tiles
{
    ...
    {
        public override string Texture => "CalamityOverhaulLegacy/Content/Tiles/InfiniteToilet" ;
        ...
        public override void ModifySittingTargetInfo(int i, int j, ref TileRestingInfo info)
        {
            ...
            info.TargetDirection = frameCheck ? 1 : -1 ;
            int xPos = tile.TileFrameX / 18 ;
            if (xPos == 1) i-- ;
            if (xPos == 2) i++ ;
            info.AnchorTilePosition.X = i + (frameCheck ? -1 : 1) ;
            info.AnchorTilePosition.Y = j ;
            if (tile.TileFrameY % 40 == 0) info.AnchorTilePosition.Y++ ;
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<InfiniteToiletItem>() ;
        }
